      ...
      allCards
        ...
        .filter(card => {
          ...
          if (displayTagFilterIds.length > 0) {
            ...
            const matches = displayTagFilterIds.some(id => cardTagIds.has(id))
            if (!matches) {
              return false
            }
          }
                      ...
                      const count =
                        option.value === 'all'
                          ...
                          : (priorityCounts.counts[
                              option.value as KanbanPriority
                            ] ?? 0)
                      return (
                        <SelectItem
                          key={option.value}
