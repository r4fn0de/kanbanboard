...
export function BoardNavbar({
  ...
  const shouldRenderControlSection = shouldRenderControls || Boolean(dueSummaryData)
      ...
      <div className="flex items-center gap-4 px-4 py-3 md:px-6 lg:h-16 overflow-hidden">
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <h1 className="truncate text-lg font-semibold text-foreground">{boardTitle}</h1>
          </div>
        </div>
                ...
                {dueSummaryData ? (
                  <div className="hidden min-w-max items-center gap-2 text-xs sm:flex sm:text-sm">
                    {dueSummaryData.overdue > 0 && (
                      <Badge variant="destructive">Overdue {dueSummaryData.overdue}</Badge>
                    )}
                    {dueSummaryData.today > 0 && (
                      <Badge className="border border-yellow-500/20 bg-yellow-500/10 text-yellow-600 dark:text-yellow-300">
                    ...
                    {dueSummaryData.overdue + dueSummaryData.today + dueSummaryData.soon === 0 && (
