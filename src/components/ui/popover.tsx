      ...
      >
        <span
          className={cn(
            ...
            'max-h-80 w-full overflow-y-auto p-4',
            tooltipStyle &&
              'w-fit rounded-md text-xs text-balance shadow-md shadow-black/5 before:rounded-[calc(var(--radius-md)-1px)] px-[calc(--spacing(2)+1px)] py-[calc(--spacing(1)+1px)]',
            className
          )}
        >
